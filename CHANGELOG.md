...
- **1.0.18.110** (Latest): Removed the Drop Zone delete confirmation modal and replaced it with a **double-click deletion** system for a faster, cleaner, and more intuitive UX. Improved overall UI flow. Introduced a **limit of 3 simultaneous uploads** to prevent overhead and ensure better stability during heavy usage.
