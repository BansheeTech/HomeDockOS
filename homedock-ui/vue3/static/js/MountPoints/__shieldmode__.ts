...
import ShieldMode from "../__Layouts__/ShieldMode.vue";
...
if (themeData) {
  const app = createApp(ShieldMode);
  ...
  console.error("Required data is missing or invalid. Cannot initialize ShieldMode.");
}
