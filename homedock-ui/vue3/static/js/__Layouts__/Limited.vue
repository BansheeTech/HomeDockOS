...
import _anim_slow from "@iconify-icons/mdi/speedometer-slow";
import _anim_medium from "@iconify-icons/mdi/speedometer-medium";
import _anim_high from "@iconify-icons/mdi/speedometer";
