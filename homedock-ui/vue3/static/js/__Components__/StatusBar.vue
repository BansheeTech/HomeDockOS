...
.white-mode-theme.ant-popover .ant-popover-inner {
...
/* Dark Mode */
.dark-mode-theme.ant-popover .ant-popover-inner {
...
/* Aero Mode */
.aero-mode-theme.ant-popover {
  backdrop-filter: blur(40px) saturate(200%) !important;
  -webkit-backdrop-filter: blur(40px) saturate(200%) !important;
}

.aero-mode-theme.ant-popover .ant-popover-inner {
