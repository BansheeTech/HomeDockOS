<!-- homedock-ui/vue3/static/js/__Components__/AppDriveUploadIndicator.vue -->
...
<template>
  <Transition name="taskbar-item">
    <div v-if="isUploading" class="appdrive-upload-indicator-wrapper" ref="indicatorRef">
      <div class="appdrive-upload-indicator" :class="[themeClasses.uploadIndicatorBg, themeClasses.uploadIndicatorIcon, themeClasses.uploadIndicatorBgHover, themeClasses.uploadIndicatorIconHover]" @click="toggleDropdown">
        ...
        <Icon :icon="cubeScanIcon" class="appdrive-badge-icon" />
      </div>

      <Transition name="dropdown">
        <Teleport to="body">
          <div v-if="isExpanded" class="appdrive-upload-dropdown border" :class="[themeClasses.uploadDropdownBg, themeClasses.uploadDropdownBorder, themeClasses.uploadDropdownShadow]">
            <div class="dropdown-header px-6 py-4 rounded-t-lg text-sm font-medium flex items-center space-x-3" :class="themeClasses.topBack">
              <Icon :icon="cubeScanIcon" class="w-4 h-4" />
              <span class="dropdown-title" :class="themeClasses.notTextUp">App Drive Uploads</span>
            </div>
...
import { useAppDriveUploadingStore } from "../__Stores__/useAppDriveUploadingStore";
...
const TRAY_ID = "appdrive-upload-indicator";
...
<style scoped>
.appdrive-upload-indicator-wrapper {
  position: relative;
  user-select: none;
}

.appdrive-upload-indicator {
  display: flex;
  align-items: center;
