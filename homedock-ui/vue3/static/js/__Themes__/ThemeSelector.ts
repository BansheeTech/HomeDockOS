...
export function useTheme() {
  ...
  const themes: Record<string, Record<string, string>> = {
    default: {
      ...
      uninstallAction: "hover:bg-red-300 hover:ring-red-400 hover:animate-pulse",
      uninstallPopconfirm: "#ffffff",
      uninstallPopconfirmTextUp: "text-red-600",
      uninstallPopconfirmTextDown: "text-gray-700 mb-4",
    ...
    noir: {
      ...
      uninstallAction: "hover:bg-red-600/50 hover:ring-red-400/50 hover:animate-pulse",
      uninstallPopconfirm: "#18181c",
      uninstallPopconfirmTextUp: "text-red-600",
      uninstallPopconfirmTextDown: "text-zinc-400 mb-4",
